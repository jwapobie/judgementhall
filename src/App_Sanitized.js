...
// 			 {<img src="https://www.thiscatdoesnotexist.com" alt="thiscatdoesnotexist is down"/>}
// 			</button>
// 		);
// 	}
// }
...
function MyDropzone() {
      ...
      Jimp.read(buffer).then(img => {
  		...
  		img.scan(0, 0, img.bitmap.width, img.bitmap.height, (x, y, idx) => {
			...
			if (x === img.bitmap.width - 1 && y === img.bitmap.height - 1) {
				...
				//let string = count >= 0 ? "This image is KEK! Good job." : "Um. This is CRINGE."
  ...
  const {acceptedFiles, getRootProps, getInputProps} = useDropzone({onDropAccepted, onDropRejected, accept, disabled, multiple})
